...
| `--lang auto\|dotnet\|ts\|py` | `auto` | Source language. `auto` detects from project files; `ts` = Node/TypeScript (NestJS/Express), `py` = Python (FastAPI/Flask). Both analyzed in-process, no SDK/runtime. |
